...
export default function ArticleDetail({ articleId }: ArticleDetailProps) {
  ...
  const copyCitation = () => {
    const citation =
      "Zhang, L., Kumar, R., Smith, J., & Anderson, M. (2024). Deep Learning Approaches for Protein Structure Prediction: AlphaFold and Beyond. Nature Machine Intelligence, 6(4), 234-256. https://doi.org/10.1038/s42256-024-00789-1";
          ...
          <article className="space-y-8">
            ...
            <div className="flex items-center gap-3 pb-8 border-b border-border">
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://doi.org/10.1038/s42256-024-00789-1",
                    "_blank",
                  )
                }
              >
            ...
            <section className="space-y-4">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-foreground leading-relaxed">
                  Recent advances in deep learning have revolutionized protein
                  structure prediction. We present a comprehensive review of
                  state-of-the-art methods, focusing on AlphaFold2 and its
                  successors. Our analysis covers the architectural innovations,
                  training methodologies, and practical applications that have
                  enabled near-atomic accuracy in structure prediction.
                </p>
                <p className="text-lg text-foreground leading-relaxed mt-4">
                  We examine the key components of modern deep learning
                  architectures, including attention mechanisms, evolutionary
                  coupling analysis, and multi-sequence alignment processing.
                  The integration of these techniques has dramatically improved
                  prediction accuracy, reducing the median error from several
                  angstroms to sub-angstrom precision for many protein families.
                </p>
                <p className="text-lg text-foreground leading-relaxed mt-4">
                  Our review also discusses the limitations of current
                  approaches, including challenges with multi-domain proteins,
                  membrane proteins, and intrinsically disordered regions. We
                  propose future directions for improving prediction accuracy
                  and computational efficiency, with particular emphasis on
                  incorporating experimental constraints and developing more
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-base text-foreground font-mono leading-relaxed">
                      Zhang, L., Kumar, R., Smith, J., & Anderson, M. (2024).
                      Deep Learning Approaches for Protein Structure Prediction:
                      AlphaFold and Beyond. <em>Nature Machine Intelligence</em>
                      , 6(4), 234-256.
                      https://doi.org/10.1038/s42256-024-00789-1
                    </p>
                  </div>
