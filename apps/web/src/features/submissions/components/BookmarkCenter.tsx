...
export default function BookmarkCenter() {
  ...
  const filteredBookmarks = bookmarks.filter((bookmark) => {
    ...
    const matchesJournal =
      ...
      bookmark.journal === selectedJournal;
    const matchesYear =
      selectedYear === "All Years" || bookmark.year.toString() === selectedYear;
    const matchesTopic =
      selectedTopic === "All Topics" ||
      bookmark.keywords.some((k) =>
        k.toLowerCase().includes(selectedTopic.toLowerCase()),
      );
    const matchesAuthor = authorFilter
      ? bookmark.authors.some((a) =>
