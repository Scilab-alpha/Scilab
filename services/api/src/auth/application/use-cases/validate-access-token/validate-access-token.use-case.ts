...
import { ValidateAccessTokenInput } from '@/auth/application/use-cases/validate-access-token/validate-access-token.dto';
...
export class ValidateAccessTokenUseCase {
  ...
  async execute(input: ValidateAccessTokenInput): Promise<AuthenticatedUser> {
